...
public class InstitutionsGroupsFragment extends Fragment {
    public static ArrayList<String> mData;
    RecyclerView rv;
    SharedPreferences prefs;

    public InstitutionsGroupsFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View rootView = inflater.inflate(R.layout.institutions_groups_fragment_main_layout, container, false);
        mData = new ArrayList<>();
