...
public class GeneralRecyclerViewAdapter extends RecyclerView.Adapter<GeneralRecyclerViewAdapter.MyViewHolder> {
    ...
    public GeneralRecyclerViewAdapter(Context context, int resourceId, ArrayList<String> data, String currentFragment) {
        mData = data;
        mContext = context;
        mId = resourceId;
    ...
    @Override
    public GeneralRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int i) {
