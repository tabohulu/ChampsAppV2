...
public class InstitutionManagersFragmentAdmin extends Fragment {
    ...
    public InstitutionManagersFragmentAdmin() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bigTitle=rootView.findViewById(R.id.big_title_tv);
        bigTitle.setText("All Managers");
        ...
        newInstitutionButton.setVisibility(View.INVISIBLE);
    ...
    public void PopulateRecyclerView() {
        ...
        ParseQuery<ParseObject> query = new ParseQuery<ParseObject>("InstitutionManager");
