...
public class Adapter_AllSports extends RecyclerView.Adapter<Adapter_AllSports.MyViewHolder> {
    ...
    public Adapter_AllSports(ArrayList<Helper_BasicDataModel> dataModel, Context context) {
    ...
    @Override
    public Adapter_AllSports.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                             int viewType) {
        // create a new view
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        holder.mCardView1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //Toast.makeText(mContext, currentValue+" Selected", Toast.LENGTH_LONG).show();
                QuickCheck(currentValue);

                /*switch (position) {
                    case 0:
                        Toast.makeText(mContext, currentValue+" Selected", Toast.LENGTH_SHORT).show();


                        try {
                            Intent intent = new Intent(mContext, Activity_Common_AllSports.class);
                            intent.putExtra("sportName",currentValue);
                    ...
                    case 1:
                        ...
                        try {
                            Intent athleteIntent = new Intent(mContext, Teams_Institution_Activity2.class);
        ...
        holder.mCardView3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                int position = holder.getAdapterPosition();
                String currentValue = mRData.get(position).getTitle();
                QuickCheck(currentValue);
    ...
    public void QuickCheck(final String currentValue){
        ParseQuery<ParseObject> query=new ParseQuery<ParseObject>("AllSports");
        query.whereContains("sportName",currentValue);
        query.setLimit(1);
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> objects, ParseException e) {
                if(e==null && objects.size()>0){
                    ...
                    Toast.makeText(mContext, currentValue+" data not yet created", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
