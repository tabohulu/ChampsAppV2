...
public class AdapterExpandable_AthleteProfileEvents extends BaseExpandableListAdapter {
    ...
    public AdapterExpandable_AthleteProfileEvents(Context context, List<String> expandableListTitle,
